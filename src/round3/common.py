...
def initial_config():
    return dict(tasks=TASKS, demonstration_counts=NS, train_seeds=[0],
        ...
        batch_chunks_per_system_update=128, gpu_devices=GPUS, maximum_simultaneous_gpus=len(GPUS),
        workers_per_gpu=WORKERS_PER_GPU, maximum_simultaneous_workers=len(GPUS)*WORKERS_PER_GPU,
