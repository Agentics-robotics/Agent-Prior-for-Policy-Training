...
CONTRACT = {
    ...
    "unavailable_labels": [
        "verified task-goal annotations",
        "object identities/poses/masks",
    ...
    "gripper_feedback": "All 45,730 Flip egg rows have finite gripper_position and gripper_width_m; inspect actual values and images. Finite feedback alone does not verify grasp/contact semantics or calibration accuracy.",
