"""Developer-owned scheduling and provenance for the two independent trainings."""
...
def freeze_executor(cfg, package):
    ...
    paths = list((ROOT / "real_robot/policy_training").glob("*.py")) + [
