"""Local observation-in/API-defined-decision-out worker; no robot IO."""
...
class PolicyProcess:
    ...
    act computes API-defined policy outputs; executor_request describes an objective
