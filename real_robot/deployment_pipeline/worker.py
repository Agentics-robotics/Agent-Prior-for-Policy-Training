...
def serve(args):
    ...
    if (saved["schema"] != "real_robot.pipeline_inference_checkpoint.v1" or
    ...
    device = lockdown(package / "source",output,
        [checkpoint,assets,ROOT / "real_robot/deployment_pipeline",ROOT / "real_robot/deployment"],gpu=True)
