"""Check downloadable source/weights and load the three local inference workers."""

import argparse
import json

from real_robot.deployment.common import verify
...
def main():
    ...
    if manifest.get("api_contract") != "push_training_v3":
        raise ValueError("Expected training_v3 source and weights")
    print(
        json.dumps(
