...
def launch(gpu, args):
    ...
    os.execvp(
        ...
        + [
            ...
            "-u",
            "-m",
            "real_robot.deployment_v3.worker",
            *args,
            "--isolated",
        ],
    )
...
def serve(args):
    ...
    from real_robot.policy_training_v3.security import lockdown
    ...
    if manifest.get("api_contract") != "push_training_v3":
        raise ValueError("This worker only accepts the training_v3 API contract")
    ...
    for line in sys.stdin:
        ...
        if operation == "inventory":
            ...
            result["scene_version"] = request["scene_version"]
        elif operation == "act":
