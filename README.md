...
| Real robot / Push | [v3 跨电脑推理接口](real_robot/deployment_v3/)、[API 模型与逐策略文档](real_robot/policies/push_v3/source/POLICY_CATALOG.md)、[v3 训练接口](real_robot/policy_training_v3/) | [v3 下载与调用](real_robot/deployment_v3/README.md)、[v3 训练与覆盖](real_robot/reports/PUSH_TRAINING_V3.md)、[cut_v5 中文成品与对照](real_robot/reports/PUSH_CUT_V5_REVIEW.md)、[小数据通用 prompt](real_robot/prompts/general_cut_and_prior_v3.md) | 外部原始 push_letters 配对记录，只读引用；[cut_v5](real_robot/data/push_letters/cut_v5/) 的 2 个子任务组、26 段全部保留动作监督，旧 cut_v3/v4 保留 | training_v3 三个模型各完成 20,000 步，EMA 重载误差 0；完整推理包约 22 MiB，[迁移检查通过](real_robot/reports/PUSH_V3_DEPLOYMENT.md)。无真机或泛化评估；[v2](real_robot/reports/PUSH_TRAINING_V2.md)、[v1](real_robot/reports/PUSH_TRAIN.md) 保留 |
